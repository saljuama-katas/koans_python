...
class AboutIteration(Koan):
    ...
    def test_reduce_will_blow_your_mind(self):
        ...
        # Extra Credit: Describe in your own words what reduce does.
        # Given a collection, reduces it to a single element by applying a
        # given function to each element against an accumulated result and
    ...
    def test_all_iteration_methods_work_on_any_sequence_not_just_lists(self):
        ...
        try:
            ...
            try:
                def make_upper_case(line): return line.strip().upper()
                upper_case_lines = map(make_upper_case, file.readlines())
                self.assertEqual(['THIS', 'IS', 'A', 'TEST'], list(upper_case_lines))
            finally:
                # Arg, this is ugly.
